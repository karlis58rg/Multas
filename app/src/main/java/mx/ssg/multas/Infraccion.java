...
public class Infraccion extends AppCompatActivity implements MapaInfraccion.OnFragmentInteractionListener {
    ...
    public void iniciar_fragment(){
        Fragment fragmento = new MapaInfraccion();
        getSupportFragmentManager().beginTransaction().replace(R.id.contenedorInfraccion, fragmento).commit();
    }
    ...
    public void solicitarPermiso(){
        if(ActivityCompat.shouldShowRequestPermissionRationale(activity, Manifest.permission.ACCESS_FINE_LOCATION)){
            Toast.makeText(Infraccion.this, "PERMISOS ACTIVADOS", Toast.LENGTH_SHORT).show();
        } else {
